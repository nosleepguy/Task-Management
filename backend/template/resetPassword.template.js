export default function (username, link) {
    return {
        subject: "[Đặt lại mật khẩu] DEV.TO VietNam",
        html: `<!DOCTYPE html>
        <html lang="en">
                ...
                <td class="container"
                  ...
                  <div class="content"
                    ...
                    <span class="preheader"
                      style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Hãy xác nhận Email.</span>
                                  ...
                                  <tr>
                                    <td
                                      ...
                                      <p
                                        ...
                                        Bạn nhận được email này vì chúng tôi đã nhận được yêu cầu đặt lại mật khẩu cho tài khoản
                                        của bạn.<br/>
                                        Vui lòng nhấp vào link dưới đây để đặt lại mật khẩu của bạn.<br />
                                    </td>
                                  </tr>
                                  <tr>
                                    <td
                                                  ...
                                                  <tr>
                                                    <td align="center" bgcolor="#348eda"
                                                      ...
                                                      valign="top"><a href="${link}"
                                                        ...
                                                        target="_blank">Đặt lại mật khẩu</a></td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                            </td>
                            ...
                            <td align="center" class="align-center"
                              ...
                              <p
                                ...
                                <a href="https://sendgrid.com/blog/?utm_campaign=website&amp;utm_medium=email&amp;utm_source=sendgrid.com"
                                  ...
                                  href="https://github.com/sendgrid?utm_campaign=website&amp;utm_source=sendgrid.com&amp;utm_medium=email"
                                  style="box-sizing: border-box; color: #348eda; font-weight: 400; text-decoration: none; font-size: 12px; padding: 0 5px;"
                                  target="_blank">GitHub</a> <a
                                  href="https://twitter.com/sendgrid?utm_campaign=website&amp;utm_source=sendgrid.com&amp;utm_medium=email"
                                  style="box-sizing: border-box; color: #348eda; font-weight: 400; text-decoration: none; font-size: 12px; padding: 0 5px;"
                                  target="_blank">Twitter</a> <a
                                  href="https://www.facebook.com/SendGrid?utm_campaign=website&amp;utm_source=sendgrid.com&amp;utm_medium=email"
                                  style="box-sizing: border-box; color: #348eda; font-weight: 400; text-decoration: none; font-size: 12px; padding: 0 5px;"
                                  target="_blank">Facebook</a> <a
                                  href="https://www.linkedin.com/company/sendgrid?utm_campaign=website&amp;utm_source=sendgrid.com&amp;utm_medium=email"
                                  style="box-sizing: border-box; color: #348eda; font-weight: 400; text-decoration: none; font-size: 12px; padding: 0 5px;"

			...
			<div>
				...
				<div className="sort flex m-4 mt-2 justify-end">
					...
					<button className="p-2 bg-white rounded-[50px] ml-2">
						<Category size="15" color="currentColor" variant="Outline" />
					</button>
					<button className="p-2 bg-white rounded-[50px] ml-2">
						<RowVertical size="15" color="currentColor" variant="Outline" />
					</button>
					<button className="p-2 bg-white rounded-[50px] ml-2 mr-1">
						<RowHorizontal size="15" color="currentColor" variant="Outline" />
					</button>
				</div>
			</div>
